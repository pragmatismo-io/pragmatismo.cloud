  ...
  return (
    <div className="w-full py-40 lg:py-40">
      <div className="container mx-auto">
        <div className="flex gap-8 py-40 lg:py-40 items-center justify-center flex-col">
          <div>
          ...
          <div className="flex gap-4 flex-col">
            ...
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
              Rapidly deploy AI chatbots leveraging your knowledge base and
              BASIC skills.
            </p>
          </div>
        ...
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Do automation the self way. Do your work from your WhatsApp or any
              channel.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col gap-2">
              <a href="/features/ai-search">
                ...
                <p className="text-muted-foreground text-base">
                  Deploy AI-driven search capabilities for corporate documents,
                  covering PDF and .docx formats, facilitating seamless access
            ...
            <div className="flex flex-col gap-2">
              <a href="/features/content-generation">
                ...
                <p className="text-muted-foreground text-base">
                  Strategic content creation across diverse platforms acts as
                  the engine propelling business growth while nurturing audience
                  engagement.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/features/bot-factory">
                ...
                <p className="text-muted-foreground text-base">
                  Unleash limitless chatbots and virtual assistants to transform
                  all system interactions into natural conversations.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/features/talk-to-data">
                ...
                <p className="text-muted-foreground text-base">
                  Bots for data-driven decision-making oriented culture, guiding
                  conversations in a conversational and actionable manner.
                </p>
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <a href="/features/broadcast">
                ...
                <p className="text-muted-foreground text-base">
                  Effortlessly reach out to vast audiences on WhatsApp or
                  Enterprise. Craft bespoke conversation experiences by
                  customizing AI-backed message replies.
                </p>
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <a href="/features/trainning">
                ...
                <h3 className="text-xl tracking-tight">
                  Train with well-known tools
                </h3>
                <p className="text-muted-foreground text-base">
                  Use Tools you know to edit content like MS Word or Excel.
                  Train by using natural language with no code or diagram
                  skills.
                </p>
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <a href="/features/web-automation">
                ...
                <p className="text-muted-foreground text-base">
                  Perform web tasks with General Bots® Web Automation scrapping
                  data from sites or getting key indicators from online
                  services.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/features/llm-tools">
                ...
                <p className="text-muted-foreground text-base">
                  Streamline the creation of web services in BASIC and develop
                  LLM tools, seamlessly callable by your Large Language Models.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/features/create-apis-in-word">
                ...
                <p className="text-muted-foreground text-base">
                  In simplified BASIC code, you can easily send and receive data
                  from remote servers by using HTTP rest.
                </p>
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-10">
          <div className="flex gap-4 flex-col items-start">
            ...
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg max-w-xl lg:max-w-lg leading-relaxed tracking-tight text-muted-foreground  text-left">
                General Bots is omni-channel, so you can design conversations
                across channels providing 'get things done' faster.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col gap-2" >
              <a href="/integrations/channels/whatsapp">
                <div className="bg-muted containercenter rounded-md aspect-video mb-2">
                  <Image
                ...
                <p className="text-muted-foreground text-base">
                  Connect with your audience through WhatsApp Official
                  integration.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/sms">
                <div className="bg-muted rounded-md containercenter aspect-video mb-2">
                  <MessageSquareIcon className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">SMS</h3>
                <p className="text-muted-foreground text-base">
                  Reach out to customers via SMS for instant communication.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/web-chat">
                <div className="bg-muted rounded-md aspect-video mb-2 containercenter">
                  <CgWebsite className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">
                  Web Chat in your site
                </h3>
                <p className="text-muted-foreground text-base">
                  Integrate a web chat feature directly into your website for
            ...
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/instagram">
                ...
                <p className="text-muted-foreground text-base">
                  Engage with your audience through Instagram Direct Messages.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/email">
                <div className="bg-muted rounded-md aspect-video mb-2 containercenter">
                  <MdOutlineEmail className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">E-mail</h3>
                <p className="text-muted-foreground text-base">
                  Communicate with your customers via email for important
            ...
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/microsoft-teams">
                <div className="bg-muted rounded-md aspect-video mb-2 containercenter">
                  <PiMicrosoftTeamsLogo className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">Microsoft Teams</h3>
                <p className="text-muted-foreground text-base">
                  Collaborate efficiently with your team using Microsoft Teams
                  integration.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/google-chat">
                <div className="bg-muted rounded-md aspect-video mb-2 containercenter">
                  <SiGooglechat className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">Google Chat</h3>
                <p className="text-muted-foreground text-base">
                  Stay connected with your team through Google Chat integration.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/facebook-pages">
                <div className="bg-muted rounded-md aspect-video mb-2 containercenter">
                  <MdFacebook className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">Facebook Pages</h3>
                <p className="text-muted-foreground text-base">
                  Engage with your audience on Facebook Pages with ease.
                </p>
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <a href="/integrations/channels/slack">
                <div className="bg-muted rounded-md aspect-video mb-2 containercenter">
                  <IoLogoSlack className="ml-2 mr-1 w-16 h-16 inline-block" />
                </div>
                <h3 className="text-xl tracking-tight">Slack</h3>
                <p className="text-muted-foreground text-base">
                  Communicate and collaborate with your team via Slack
                  integration.
                </p>
              </a>
            </div>
