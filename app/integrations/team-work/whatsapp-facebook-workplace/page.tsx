    ...
    <div className="container mx-auto">
        ...
        <div className="flex gap-4 flex-col">
          ...
          <div className="flex gap-4 flex-col">
            <h1 className="text-5xl md:text-7xl max-w-lg tracking-tighter text-left font-regular">
              Transforming Business with Facebook Workplace Integration
            </h1>
            <p className="text-xl leading-relaxed tracking-tight text-muted-foreground max-w-md text-left">
              Empower your business with seamless connectivity between WhatsApp and Facebook Workplace (Chat). Enhance customer governance and support using AI-driven bots.
            </p>
          </div>
            ...
            <div className="flex flex-row gap-6 w-full items-start">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-muted-foreground text-sm">
                  Connect WhatsApp and Facebook Workplace (Chat) effortlessly for unified communication.
                </p>
              </div>
            </div>
          ...
          <div className="flex gap-4 flex-col">
            ...
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg leading-relaxed tracking-tight text-muted-foreground max-w-xl text-left">
                Explore the advantages of integrating WhatsApp and Facebook Workplace (Chat) for your business.
              </p>
            </div>
          </div>
      ...
      <div className="flex gap-4 py-12 lg:py-12 flex-col items-start">
        ...
        <div className="flex gap-2 flex-col">
          ...
          <p className="text-lg max-w-xl lg:max-w-xl leading-relaxed tracking-tight text-muted-foreground">
            Discover the simplicity of integrating WhatsApp and Facebook Workplace (Chat) into your daily operations.
          </p>
        </div>
        <div className="flex gap-10 pt-12 flex-col w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Easily connect WhatsApp and Facebook Workplace (Chat) through our intuitive setup process.
              </p>
            </div>
            <div className="flex flex-col bg-white rounded-lg shadow-lg p-6">
